...
public class ParksAdapter extends RecyclerView.Adapter<ParksAdapter.MyViewHolder> {

    private List<Place> places;
    private Context context;
    private String parks = MainActivity.parks;
    // 1 = pub, 2 = restaurant, 3 = parks, 4 = shops
    private int current_place = 3;
    ...
    public ParksAdapter(Context context, List<Place> places) {
        this.places = places;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.setClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                intent.putExtra(MainActivity.parks, parks);
